...
import { handleDeleteArticle } from '../redux/actions';

const Cart = ({panierArticle, handleDeleteArticle}) => {
              ...
              <tbody>
              {
                panierArticle && panierArticle.map(article => {
                  return (
                    ...
                    <td class="px-4 py-3">
                        <input name="quantity" type="number" class="w-12 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-right outline-none text-gray-700 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out" value={article.quantity} />
                    ...
                    <td class="px-4 py-3 text-right">{article.unit_price_incl_vat} €</td>
                    <td class="px-4 py-3 text-right">{article.vat_category}%</td>
